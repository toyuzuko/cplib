...
from cplib.geometry.floating import Circle, Point, common_tangent_points
...
points = common_tangent_points(Circle(Point(x1, y1), r1), Circle(Point(x2, y2), r2))
for point in points:
    FastIO.writeln(f'{point.x:.10f} {point.y:.10f}')
